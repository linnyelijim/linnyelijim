...
int main()
{
	...
	do
	{
		...
		case '4': // print out the calendar of specified year to yourname.txt file
			get_input(year);
			print_calendar(year, "ljimenez.txt");
			cout << "\n\tCalendar of year 2016 has be print to file ljimenez.txt";// you implement this ******************
			break;
		...
		default: // other choices that are not the options on menu. 
			cout << "\n\tError, no such choice. Please choose from Menu.\n";//print out error message
			break;
		}
		cout << "\n\n\t";
		system("pause");
